...
public abstract class AsyncTask<Params, Progress, Result> {
	...
	public AsyncTask() {
		this(new CallbackHandler(Looper.getMainLooper()));
	}
	 ...
	 */
	public AsyncTask(CallbackHandler callbackHandler) {
		...
		this.future = new FutureTask<Result>(worker) {
			@Override
			protected void done() {
				try {
	...
	private Result postResult(Result result) {
		if (callbackHandler != null) {
			...
			Message message = callbackHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskResult<>(this, result));
	...
	protected final void publishProgress(Progress... values) {
		if (!isCancelled()) {
			if (callbackHandler != null) {
				callbackHandler.obtainMessage(MESSAGE_POST_PROGRESS, new AsyncTaskResult<>(this, values)).sendToTarget();
			} else {
